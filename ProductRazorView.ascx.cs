    ...
    public partial class ProductRazorView : NBrightBuyFrontOfficeBase
    {
        ...
        override protected void OnInit(EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var prdData = ProductUtils.GetProductData(Convert.ToInt32(_eid),Utils.GetCurrentCulture(), true);
        ...
        {
            var productData = ProductUtils.GetProductData(Convert.ToInt32(entryId), Utils.GetCurrentCulture(),true);
